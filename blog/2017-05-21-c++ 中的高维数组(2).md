...
```{.cpp include=cpp_src/high_dim_array_1.cpp}
```
...
```{.cpp include=cpp_src/high_dim_array_2.cpp}
```
...
```{.cpp include=cpp_src/high_dim_array_3.cpp}
```

```{.cpp include=cpp_src/high_dim_array_4.cpp}
```
